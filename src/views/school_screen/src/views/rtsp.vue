  ...
  <div class="container">
    ...
    <div class="content_view">
      ...
      <div class="content_center_view">
        <!-- 视频播放 -->
        <div v-if="push_show" class="top_card_view">
          <div class="video_fl_view">
            <div v-if="video_list.equ_no" :id="'video' + video_list.equ_no" class="video_card top_video_fl">
              <template v-if="video_list.equ_no !== ''">
                <template v-if="video_list.rtsp !== null && video_list.rtsp !== ''">
                  <object
                    v-if="show_video"
                    :id="'videoElement' + video_list.equ_no"
                    class="video_item_content"
                    type="application/x-vlc-plugin"
                    events="True"
                    pluginspage="http://www.videolan.org"
                    codebase="http://downloads.videolan.org/pub/videolan/vlc-webplugins/2.0.6/npapi-vlc-2.0.6.tar.xz"
                  >
                    <param name="mrl" :value="video_list.rtsp">
            ...
            <div class="video_bottom">
              <div class="video_card video_fl">
                <template v-if="video_list1[0] && video_list1[0].equ_no !== ''">
                  <template v-if="video_list1[0].rtsp !== null && video_list1[0].rtsp !== ''">
                    <object
                      v-if="show_video1"
                      :id="'videoElement' + video_list1[0].equ_no"
                      class="video_item_content"
                      type="application/x-vlc-plugin"
                      events="True"
                      pluginspage="http://www.videolan.org"
                      codebase="http://downloads.videolan.org/pub/videolan/vlc-webplugins/2.0.6/npapi-vlc-2.0.6.tar.xz"
                    >
                      <param name="mrl" :value="video_list1[0].rtsp">
                      <param name="volume" value="0">
                      <param name="autoplay" value="true">
                      <param name="loop" value="false">
                      <param name="mute" value="true">
                  ...
                  <div class="video_info_demo">
                    <img src="../assets/video_icon.png" alt="">
                    <span class="video_info_txt">{{ video_list1[0].equ_name }}</span>
                  </div>
                </template>
                <template v-else>
                  <div class="no-video-url">
              ...
              <div class="video_card video_fl">
                <template v-if="video_list1[1] && video_list1[1].equ_no !== ''">
                  <template v-if="video_list1[1].rtsp !== null && video_list1[0].rtsp !== ''">
                    <object
                      v-if="show_video2"
                      :id="'videoElement' + video_list1[1].equ_no"
                      class="video_item_content"
                      type="application/x-vlc-plugin"
                      events="True"
                      pluginspage="http://www.videolan.org"
                      codebase="http://downloads.videolan.org/pub/videolan/vlc-webplugins/2.0.6/npapi-vlc-2.0.6.tar.xz"
                    >
                      <param name="mrl" :value="video_list1[1].rtsp">
                      <param name="volume" value="0">
                      <param name="autoplay" value="true">
                      <param name="loop" value="false">
                      <param name="mute" value="true">
                  ...
                  <div class="video_info_demo">
                    <img src="../assets/video_icon.png" alt="">
                    <span class="video_info_txt">{{ video_list1[1].equ_name }}</span>
                  </div>
                </template>
                <template v-else>
                  <div class="no-video-url">
              ...
              <!--<div v-for="(item, index) in video_list1" :key="index" class="video_card video_fl">
                <template v-if="item.equ_no !== ''">
                  <template v-if="item.rtsp !== null && item.rtsp !== ''">
                    <object
                      :id="'videoElement' + item.equ_no"
                      class="video_item_content"
                      type="application/x-vlc-plugin"
                      events="True"
                      pluginspage="http://www.videolan.org"
          ...
          <div class="video_fr_view">
            <div class="video_card video_fr">
              <template v-if="video_list2[0] && video_list2[0].equ_no !== ''">
                <template v-if="video_list2[0].rtsp !== null && video_list2[0].rtsp !== ''">
                  <object
                    v-if="show_video3"
                    :id="'videoElement' + video_list2[0].equ_no"
                    class="video_item_content"
                    type="application/x-vlc-plugin"
                    events="True"
                    pluginspage="http://www.videolan.org"
                    codebase="http://downloads.videolan.org/pub/videolan/vlc-webplugins/2.0.6/npapi-vlc-2.0.6.tar.xz"
                  >
                    <param name="mrl" :value="video_list2[0].rtsp">
                    <param name="volume" value="0">
                    <param name="autoplay" value="true">
                    <param name="loop" value="false">
                    <param name="mute" value="true">
                ...
                <div class="video_info_demo">
                  <img src="../assets/video_icon.png" alt="">
                  <span class="video_info_txt">{{ video_list2[0].equ_name }}</span>
                </div>
              </template>
              <template v-else>
                <div class="no-video-url">
            ...
            <div class="video_card video_fr">
              <template v-if="video_list2[1] && video_list2[1].equ_no !== ''">
                <template v-if="video_list2[1].rtsp !== null && video_list2[1].rtsp !== ''">
                  <object
                    v-if="show_video4"
                    :id="'videoElement' + video_list2[1].equ_no"
                    class="video_item_content"
                    type="application/x-vlc-plugin"
                    events="True"
                    pluginspage="http://www.videolan.org"
                    codebase="http://downloads.videolan.org/pub/videolan/vlc-webplugins/2.0.6/npapi-vlc-2.0.6.tar.xz"
                  >
                    <param name="mrl" :value="video_list2[1].rtsp">
                    <param name="volume" value="0">
                    <param name="autoplay" value="true">
                    <param name="loop" value="false">
                    <param name="mute" value="true">
                ...
                <div class="video_info_demo">
                  <img src="../assets/video_icon.png" alt="">
                  <span class="video_info_txt">{{ video_list2[1].equ_name }}</span>
                </div>
              </template>
              <template v-else>
                <div class="no-video-url">
            ...
            <div class="video_card video_fr">
              <template v-if="video_list2[2] && video_list2[2].equ_no !== ''">
                <template v-if="video_list2[2].rtsp !== null && video_list2[2].rtsp !== ''">
                  <object
                    v-if="show_video5"
                    :id="'videoElement' + video_list2[2].equ_no"
                    class="video_item_content"
                    type="application/x-vlc-plugin"
                    events="True"
                    pluginspage="http://www.videolan.org"
                    codebase="http://downloads.videolan.org/pub/videolan/vlc-webplugins/2.0.6/npapi-vlc-2.0.6.tar.xz"
                  >
                    <param name="mrl" :value="video_list2[2].rtsp">
                    <param name="volume" value="0">
                    <param name="autoplay" value="true">
                    <param name="loop" value="false">
                    <param name="mute" value="true">
                ...
                <div class="video_info_demo">
                  <img src="../assets/video_icon.png" alt="">
                  <span class="video_info_txt">{{ video_list2[2].equ_name }}</span>
                </div>
              </template>
              <template v-else>
                <div class="no-video-url">
            ...
            <div v-if="warning_info.equ_no && warning_info.equ_no !== ''" class="real_cell1">
              ...
              <template v-else>
                <div class="real_video_img_new" @click="handlePlay(warning_info, warning_info.video_url)">
                  <video id="real_video_img" :poster="warning_info.img_small_url" style="width: 80px; height: 80px;object-fit: cover !important;" />
              ...
              <div v-for="(item, index) in warning_list" :key="index" class="real_cell">
                ...
                <template v-else>
                  <div class="real_video_img" @click="handlePlay(item, item.video_url)">
                    <video class="video_img_item" :poster="item.img_small_url" style="width: 80px; height: 80px;object-fit: cover !important;" />
                    <img src="../assets/real_icon_3.png" class="real_icon_2" alt="">
                  </div>
                </template>
                <div class="real_content">
    ...
    <transition name="el-fade-in-linear">
      <div v-if="video_show" class="bounced-content">
        ...
        <div class="video_floating">
          <video ref="play_video" class="floating-video-item" :poster="play_video.img_small_url" :autoplay="true" :src="play_video.src" />
        </div>
      </div>
    </transition>
    <!-- 设置弹框 -->
    ...
    handleAddWarning(data) {
      ...
      if (Number(data.event_flag) === 0) {
        ...
        if (video_info.equ_no !== data.equ_no) {
          ...
          if (name !== '') {
            if (video_info.rtsp && video_info.rtsp !== '') {
              this.$set(this, 'video_list', arr)
              this[name][str] = video_info
              if (name === 'video_list1') {
                if (Number(str) === 0) {
                  show_name = 'show_video1'
                  this.show_video1 = false
                } else {
                  show_name = 'show_video2'
                  this.show_video2 = false
                }
              } else {
                if (Number(str) === 0) {
                  show_name = 'show_video3'
                  this.show_video3 = false
                } else if (Number(str) === 1) {
                  show_name = 'show_video4'
                  this.show_video4 = false
                } else {
                  show_name = 'show_video5'
                  this.show_video5 = false
                }
              }
              this.$nextTick(() => {
              ...
              // this.$nextTick(() => {
              //   setTimeout(() => {
              //     this.videoDemo(this.video_list.rtsp, 'videoElement' + this.video_list.equ_no, 'divElement' + this.video_list.equ_no, 'imgElement' + this.video_list.equ_no, 0)
              //   }, 300)
              //   setTimeout(() => {
              //     this.videoDemo(video_info.rtsp, 'videoElement' + video_info.equ_no, 'divElement' + video_info.equ_no, 'imgElement' + video_info.equ_no, flv_index)
              //   }, 600)
              // })
            } else {
              this.$set(this, 'video_list', arr)
            ...
            if (this.video_show_list.length !== 0) {
              this.video_show_list.map((item) => {
                if (item.equ_no === data.equ_no) {
                  if (this.video_list.rtsp && this.video_list.rtsp !== '') {
    ...
    handlePlay(info, url) {
      if (url && url !== '') {
        this.$nextTick(() => {
          ...
          this.play_video.img_small_url = info.img_small_url
        ...
        if (this.set_video_main) {
          ...
          if (this.video_list.equ_no !== arr_item[0].equ_no) {
            ...
            this.$nextTick(() => {
              ...
              // this.videoDemo(this.video_list.rtsp, 'videoElement' + this.video_list.equ_no, 'divElement' + this.video_list.equ_no, 'imgElement' + this.video_list.equ_no, 0)
              // setTimeout(() => {
              //   this.videoDemo(obj.rtsp, 'videoElement' + obj.equ_no, 'divElement' + obj.equ_no, 'imgElement' + obj.equ_no, flv_index)
              // }, 200)
            })
            this.set_index = 1
            this.set_video_show = false
