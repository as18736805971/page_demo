<template>
  <div id="tags-view-container" class="tags-view-container">
    <div class="tags-view-wrapper oper-go-left">
      <span class="tags-view-item" style="width: 100%;" @click="go_left"><svg-icon icon-class="go-left" class="tag-oper-icon" /></span>
    </div>
    <scroll-pane ref="scrollPane" class="tags-view-wrapper tags">
      ...
      >
        ...
        <span v-if="visitedViews.length > 1" class="tag-close" @click.prevent.stop="closeSelectedTag(tag)">
          <svg-icon icon-class="close" />
        </span>
      </router-link>
    </scroll-pane>
    <div class="tags-view-wrapper tag-view-right">
      <div class="tags-view-item oper-go-right" @click="go_right"><svg-icon icon-class="go-right" class="tag-oper-icon" /></div>
  ...
  methods: {
    ...
    filterAffixTags(routes, basePath = '/') {
      ...
      routes.forEach(route => {
        ...
        if (route.child_menu) {
          const tempTags = this.filterAffixTags(route.child_menu, route.path)
