  ...
  <div class="audio-component">
    <div class="audio-content">
      <div class="audio-left">
        <img v-if="audio.playing" class="play-icon" :src="require('@/assets/images/suspended.png')" @click="startPlayOrPause">
        <img v-else class="play-icon" :src="require('@/assets/images/play.png')" @click="startPlayOrPause">
