<template>
  <div class="schvision_main">
    ...
    <template v-if="type === 1">
      <div class="monitor_list" ref="monitor_list">
...
export default {
  ...
  activated() {
    this.$refs.monitor_list.scrollTop = this.offsetTop
  },
  beforeRouteLeave(to, from, next) {
    this.offsetTop = this.$refs.monitor_list.scrollTop
    next()
  },
  methods: {
    ...mapMutations(["UPDATE_INCLUDE_PAGE"]),
    get_camera() {
      httpFormPostMethod("web/camera/scl/tea/group", {}).then((res) => {
