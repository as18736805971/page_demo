...
export function identifyPaginate(data) {
  return request({
    url: '/api/dd/riskpoint/info/paginate',
    method: 'post',
    data: {
...
export function emergencyList() {
  return request({
    url: '/api/dd/riskpoint/measures/emergency/list',
    method: 'post',
    showLoading: false,
    data: {}
  })
...
export function saveRisk(data) {
  return request({
    url: '/api/dd/riskpoint/info/save',
    method: 'post',
    showLoading: false,
    data: {
      emergency_id: data.measure_id,
      risk_name: data.risk_name,
      ...
      emergency_measure: data.emergency_measure
    }
  })
}
...
export function updateRisk(data) {
  return request({
    url: '/api/dd/riskpoint/info/update',
    method: 'post',
    showLoading: false,
    data: {
      id: data.id,
      emergency_id: data.measure_id,
      before_emergency_id: data.before_emergency_id,
      risk_name: data.risk_name,
      potential_risk: data.potential_risk,
      risk_result: data.risk_result,
      control_measure: data.control_measure,
...
export function deleteRisk(Id) {
  return request({
    url: '/api/dd/riskpoint/info/delete',
    method: 'post',
    showLoading: false,
    data: {
      id: Id
...
// 获取风险点辨识详情
export function gainRiskDetail(risk_id) {
  return request({
    url: '/api/dd/riskpoint/info/detail',
    method: 'post',
    data: {
      risk_id: risk_id
    }
...
// 添加风险点管控
export function saveMeasures(risk_id, risk_category, measures_type, risk_result, measures_content, response_man, attachment_url, attachment_name, attachment_ext) {
  return request({
...
// 修改风险点管控
export function updateMeasures(id, risk_category, risk_result, risk_id, measures_type, measures_content, response_man) {
  return request({
...
// 绑定ufc
export function bindNFC(risk_id, nfc_code) {
  return request({
    url: '/api/dd/riskpoint/info/bind',
    method: 'post',
    showLoading: false,
    data: {
      risk_id: risk_id,
...
export function unbindNFC(risk_id) {
  return request({
    url: '/api/dd/riskpoint/info/unbind',
    method: 'post',
    showLoading: false,
    data: {
      risk_id: risk_id
...
export function getQrCode(risk_id) {
  return request({
...
// 风险点巡检码
export function inspectionCode(risk_id) {
  const data = {
    risk_id: risk_id
  }
  data['app_id'] = getAppId()
  ...
  data['token'] = getToken()
  data['sign'] = getSign(data)
  let url = process.env.VUE_APP_BASE_API + '/api/dd/riskpoint/info/patrol/card/one?'
  for (const i in data) {
    url += i + '=' + data[i] + '&'
  }
  return url
